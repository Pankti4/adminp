      ...
      ?>
          ...
          <form method="get">
                <div class="form-group">
                    <input type="text" name="searchKeyword" class="form-control" placeholder="Search by Product Name" value="<?= $searchKeyword; ?>">
    ...
    <div class="col-md-12">
      <div class="row">
        ...
        <div class="col-6 text-right">
          <a href="<?php echo base_url().'user/User1/create';?>" class="btn btn-primary">Add New Products</a>
        </div>
      </div>
      <hr>
    </div>
    ...
    <div class="col-md-12">
      <table class="table table-striped">
        ...
        <tr>
          ...
          <td>
            <a href="<?php echo base_url().'user/User1/edit/'.$pr['id']?>" class="btn btn-primary">Edit</a>
          </td>

          <td>
            <a href="<?php echo base_url().'user/User1/delete/'.$pr['id']?>" class="btn btn-danger remove">Delete</a>
          </td>
